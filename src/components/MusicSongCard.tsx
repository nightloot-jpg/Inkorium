...
import { 
  ...
  Check, MoreHorizontal, Music, Radio, Disc
} from 'lucide-react';
      ...
      <div className="p-2.5 space-y-1.5">
        ...
        <div className="flex items-center justify-between pt-1.5 border-t border-gray-100 dark:border-slate-800 text-xs">
          ...
          >
            ...
            <span>{isProfileSuccess ? '¡En perfil!' : 'Perfil'}</span>
          </button>
          ...
          <div className="flex items-center gap-0.5">
            ...
            <button
              onClick={handleShare}
              className="p-1 text-gray-400 hover:text-gray-600 dark:hover:text-gray-300 rounded transition cursor-pointer"
