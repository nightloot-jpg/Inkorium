...
export const ChatBar: React.FC = () => {
  const { currentUser, users, activeChatWindows, chatMessages, closeChat, toggleMinimizeChat, sendChatMessage, openChatWith, updateUserPresence } = useInkorium();
