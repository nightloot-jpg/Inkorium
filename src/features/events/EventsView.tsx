...
export function EventsView({ session, username, onExit }: { session: any; username?: string; onExit?: () => void }) {
  ...
  return <div className="events-app">
    <style>{`
      ...
      .events-topbar{height:58px;background:linear-gradient(90deg,#48209b,#5e2db5 58%,#32166f);display:flex;align-items:center;padding:0 30px;gap:22px;color:#fff;box-sizing:border-box;position:sticky;top:0;z-index:1000;box-shadow:0 1px 0 rgba(0,0,0,.12)}
