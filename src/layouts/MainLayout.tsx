      ...
      <header className="h-14 bg-blue-800 text-white shadow-sm">
        <div className="mx-auto flex h-full w-full max-w-screen-2xl items-center px-4">
            ...
            <div className="mx-auto max-w-2xl">
              <div className="relative">
                <input
                  ...
                  className="h-9 w-full rounded-full border border-blue-950 bg-blue-700 px-4 text-sm text-white outline-none placeholder:text-blue-200 focus:border-white/50"
                />
              </div>
            </div>
          </div>
          ...
          <div className="ml-auto flex shrink-0 items-center gap-1 sm:gap-3">
            <Link to="/notifications" className="relative rounded-full p-2 hover:bg-blue-700" aria-label="Notificaciones">
              <Bell size={19} />
            ...
            <button type="button" onClick={handleSignOut} className="rounded-full p-2 hover:bg-blue-700" aria-label="Cerrar sesión">
              <LogOut size={18} />
            </button>
          </div>
        </div>
          ...
          <div className="space-y-4">
            <section className="border border-slate-200 bg-white p-4 shadow-sm">
              <div className="flex items-center gap-3">
                ...
                <div className="min-w-0">
                  <p className="truncate text-base font-bold text-slate-800">{displayName}</p>
            ...
            <section className="border border-slate-200 bg-white p-4">
              <div className="mb-2 flex items-center justify-between">
                <h3 className="text-xs font-bold uppercase tracking-wide text-slate-500">Amigos conectados (3)</h3>
                <Link to="/friends" className="text-xs font-semibold text-blue-700">Ver todos »</Link>
              </div>
              {friends.map((friend) => (
                <div key={friend.name} className="flex items-center gap-3 py-2">
                  <div className="relative shrink-0">
                    <img src={`https://i.pravatar.cc/150?img=${friend.image}`} alt="" className="h-10 w-10 rounded-full object-cover" />
                    <span className="absolute bottom-0 right-0 h-3 w-3 rounded-full border-2 border-white bg-green-500" />
                  </div>
                  <div className="min-w-0">
                    <p className="text-sm font-semibold">{friend.name}</p>
                    <p className="truncate text-xs text-slate-500">{friend.music}</p>
                  </div>
                </div>
              ))}
            </section>
          ...
          <div className="space-y-4">
            ...
            <RightCard title="EVENTOS PATROCINADOS" action="Ver todos">
              <div className="flex gap-3">
                <div className="grid h-16 w-20 shrink-0 place-items-center bg-slate-100 text-xs text-slate-500">Evento</div>
                <div className="min-w-0">
                  <p className="text-sm font-bold text-blue-700">Concierto Indie en Madrid</p>
                  <p className="mt-1 text-xs text-slate-500">Viernes, 24 de Mayo a las 21:00</p>
                  <p className="text-xs text-slate-500">Sala La Riviera</p>
                  <button type="button" className="mt-3 rounded-full border border-blue-500 px-3 py-1 text-xs font-semibold text-blue-700">Añadir a mi calendario</button>
                </div>
              </div>
            </RightCard>
            ...
            <section className="border border-slate-200 bg-white p-4">
              <div className="mb-4 flex items-center justify-between">
                <h3 className="text-xs font-bold uppercase tracking-wide text-slate-500">CALENDARIO</h3>
                <CalendarDays size={17} className="text-slate-500" />
              </div>
              <div className="flex items-center justify-between px-2 text-sm font-semibold text-slate-800"><span>‹</span><span>Julio 2026</span><span>›</span></div>
