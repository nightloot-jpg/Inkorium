  ...
  return {
    ...
    transform(code: string, id: string) {
      ...
      const patchedCode = code.includes(photoBranch)
        ? code.replace(photoBranch, `if(media?.type==='photo')return <PostMediaImage media={media}/>;`)
        : code;
